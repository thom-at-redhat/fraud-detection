...
NOTE: If you want to connect to your own storage, see xref:creating-connections-to-storage.adoc[Create connections to your own S3-compatible object storage].
