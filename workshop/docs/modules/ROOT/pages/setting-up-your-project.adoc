...
+
NOTE: If you are sharing an environment where several users who are following this tutorial at the same time, enter a unique display name for your project, for example: “Fraud detection <username>” and replace <username> with your name.
...
xref:storing-data-with-connections.adoc[Configure storage credentials]
