...
= (Optional) Create connections to your own S3-compatible object storage
...
NOTE: Skip this procedure if you completed the steps in xref:running-a-script-to-install-storage.adoc[Run an automated script for local object storage].
...
+
If you want to complete the pipelines section of this {deliverable}, go to xref:enabling-ai-pipelines.adoc[Enable AI pipelines].

* Decide whether you want to complete the _Distribute training with the Training Operator_ section of this {deliverable}. In that section, you implement a distributed training job by using Kueue for managing job resources.
//+
