...
* You set the S3 storage bucket keys, as described in xref:configuring-the-connection-to-storage.adoc[Configure storage connections].

* You configured a pipeline server, as described in xref:enabling-ai-pipelines.adoc[Enable AI pipelines].
...
* (Optional) xref:running-a-pipeline-generated-from-python-code.adoc[Run a pipeline generated from Python code]

* Serve the model, as described in xref:preparing-the-model-for-deployment.adoc[Prepare the model for deployment].
